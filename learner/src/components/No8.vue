            ...
            <div class="col-md-12">
                <div class="card specific-card mt-3">
                    <div class="card-body">
                        ...
                        <h2 class="text-center my-3">Writing: Viết một bài văn bày tỏ quan điểm</h2>
                        ...
                        <span class="badge bg-success-subtle border border-successs-subtle text-success-emphasis rounded-pill me-3">Quan điểm có được hỗ trợ bằng lý do hoặc bằng ví dụ hay
                            không?</span>
                        <span class="badge bg-success-subtle border border-successs-subtle text-success-emphasis rounded-pill">Ngữ pháp</span>
                            ...
                            <div class="word-item">
                                <div class="mb-5">
                                    ...
                                    <div class="word-info">
                                        ...
                                        <br>
                                        <strong class="ms-3">Text:</strong> {{ questions[currentIndex].questionText }}
                                    </div>
...
export default {
    ...
    setup(props) {
        ...
        const totalTime = ref(1800); // Tổng thời gian đếm ngược cho bài thi (8 phút * 60 giây)
        const timer = ref();
        const startTest = () => {
