                ...
                <div class="card specific-card mt-3">
                    <div class="card-body">
                        ...
                        <h2 class="text-center my-3">Speaking:
                            Trả lời các câu hỏi</h2>
                        <h5 class="card-title text-primary">Directions:</h5>
                        <p class="card-text">
                            Trong phần kiểm tra này, bạn sẽ trả lời ba câu hỏi. Bạn sẽ có <strong>3</strong>
                             giây để
                             chuẩn bị sau khi nghe từng câu hỏi. Bạn sẽ có <strong>15</strong> giây để phản hồi
                             Câu hỏi 5 và 6,
                             và <strong>30</strong> giây để trả lời Câu hỏi 7.
                        </p>
                ...
                <div class="card specific-card mt-3">
                    <div class="card-body">
                        ...
                        <div v-if="isReadyToTest">
                            ...
                            <button class="button bcurrentPageindg-primary" @click="refreshAllQuestions">
                                Làm lại
                            </button>
    ...
    setup(props) {
        ...
        const retrieveQuestions = async () => {
            try {
                ...
                preparingCountdown.value = questions.value.map(() => 3);
