                ...
                <div class="card specific-card mt-3">
                    <div class="card-body">
                        ...
                        <h2 class="text-center my-3">Speaking:
                            Trả lời các câu hỏi sử dụng thông tin được cung cấp</h2>
                        ...
                        <p class="card-text">
                            ...
                            sẽ có ba
                            giây để chuẩn bị và <strong>15</strong> giây để trả lời Câu hỏi 8 và 9. Bạn sẽ
                            nghe Câu hỏi 10 hai
                            lần. Bạn sẽ có 3 giây để chuẩn bị và <strong>30</strong> giây để phản hồi
                            Câu hỏi 10.
                        </p>
                        ...
                        <div v-if="isReadyToTest">
                            ...
                            <div class="word-item">
                                <div class="mb-5">
                                    ...
                                    <div v-if="questions[currentIndex].questionGroup.groupText" class="word-info mt-3 text-danger fst-italic"
                                        v-html="questions[currentIndex].questionGroup.groupText">
                                    </div>
                                    ...
                                    <div class="word-info ">
                                        ...
                                        <strong class="ms-3 text-success">Hint to answer:</strong> {{
                                            questions[currentIndex].suggestedAnswer }}
                                    </div>
    ...
    setup(props) {
        ...
        const retrieveQuestions = async () => {
            try {
                ...
                preparingCountdown.value = [45, 3, 6];
                recordingCountdown.value = [15, 15, 30];
        ...
        const startSpeechToTextRecognition = () => {
            ...
            speechRecognition.addEventListener("result", (event) => {
                ...
                // Kiểm tra nếu đây là một câu nói mới bằng cách so sánh với transcript hiện tại
                if (transcript !== currentTranscript) {
                    console.log(transcript)
                    // Cộng vào recordedText của trang hiện tại
