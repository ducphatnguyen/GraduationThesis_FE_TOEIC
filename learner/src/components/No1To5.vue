            ...
            <div class="col-md-12">
                <div class="card specific-card mt-3">
                    <div class="card-body">
                        ...
                        <h2 class="text-center my-3">Writing: Viết câu dựa vào một bức tranh</h2>
                        ...
                        <span class="badge bg-success-subtle border border-successs-subtle text-success-emphasis rounded-pill mx-3">Sự liên quan của các câu viết với bức tranh</span>
                    </div>
                </div>
                            ...
                            <div class="word-item">
                                <div class="mb-5">
                                    ...
                                    <div class="word-info mb-3" v-if="isTestSubmitted">
                                        ...
                                        <div v-html="questions[currentIndex].suggestedAnswer"></div>     
                                    </div>
