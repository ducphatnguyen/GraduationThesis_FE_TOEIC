<template>
    <div class="container">
        <div class="card border-2 rounded-bottom-2 mt-4 mb-5 border-0 shadow-lg" style="max-width: 1300px;">
            <button type="button" class="btn btn-link text-decoration-none" disabled>
                <span class="text-primary fw-bolder fs-3">HỒ SƠ CÁ NHÂN</span>
            </button>
            <div class="row">
                            ...
                            <div class="row" v-show="showProfilePage">
                                ...
                                <div class="col-sm-6 mb-3">
                                    <div class="input-group">
                                        <span class="input-group-text border-secondary" id="basic-addon1"><i
                                                class="fa-solid fa-address-book"></i></span>
                                        <Field type="text" name="name" class="form-control border-secondary custom-font"
        ...
        const profileImageFormSchema = yup.object().shape({
            image: yup
                ...
                .test("fileSize", "Tệp ảnh quá lớn", (value) => {
                    if (!value) return true; // Bỏ qua nếu không có tệp
                    return value.size <= 1024 * 1024; // Kiểm tra kích thước tệp (1024 MB)
                }),
        });
        ...
        const onFileChange = async (event) => {
            ...
            if (file) {
                ...
                if (isValid) {
                    ...
                    console.log('Lỗi: File không hợp lệ.');
                }
            } else {
