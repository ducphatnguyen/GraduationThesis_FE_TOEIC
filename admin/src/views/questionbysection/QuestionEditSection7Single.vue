...
export default defineComponent({
    ...
    setup(props) {
        ...
        const questionFormSchema = yup.object().shape({
            ...
            //     groupPassage: yup
            //     .string()
            //     .required("groupPassage phải có giá trị.")
            //     .min(2, "groupPassage phải ít nhất 2 ký tự.")
            //     .max(50, "groupPassage có nhiều nhất 500 ký tự."),

            // questionContent0: yup
            //     .string()
            //     .required("questionContent phải có giá trị.")
            //     .min(2, "questionContent phải ít nhất 2 ký tự.")
            //     .max(50, "questionContent có nhiều nhất 500 ký tự."),
            ...
            //     .max(50, "OptionA có nhiều nhất 500 ký tự."),
            // optionA1: yup
            //     .string()
            //     .required("OptionA phải có giá trị.")
            //     .min(2, "OptionA phải ít nhất 2 ký tự.")
            ...
            //     .max(50, "OptionB có nhiều nhất 500 ký tự."),
            // optionB1: yup
            //     .string()
            //     .required("OptionB phải có giá trị.")
            //     .min(2, "OptionB phải ít nhất 2 ký tự.")
            ...
            //     .max(50, "OptionC có nhiều nhất 500 ký tự."),
            // optionC1: yup
            //     .string()
            //     .required("OptionC phải có giá trị.")
            //     .min(2, "OptionC phải ít nhất 2 ký tự.")
            ...
            //     .max(50, "OptionD có nhiều nhất 500 ký tự."),
            // optionD1: yup
            //     .string()
            //     .required("OptionD phải có giá trị.")
            //     .min(2, "OptionD phải ít nhất 2 ký tự.")
            ...
            //     .min(2, "correctOption phải ít nhất 2 ký tự.")
            //     .max(50, "correctOption có nhiều nhất 500 ký tự."),
            // correctOption1: yup
            //     .string()
            //     .required("correctOption phải có giá trị.")
            //     .min(2, "correctOption phải ít nhất 2 ký tự.")
