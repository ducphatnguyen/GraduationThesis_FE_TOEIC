    ...
    <table class="table text-center table-hover shadow">
        ...
        <tbody>
            <tr v-for="(question, index) in paginatedQuestions" :key="question.questionId" 
                ...
                <td><button style="font-size: 12px" class="btn btn-success rounded-5 disabled">{{ question.usage }}</button></td>
                <td>
                ...
                <td v-html="question.questionExplanation"></td>
            </tr>
...
export default defineComponent({
    ...
    setup(props) {
        ...
        // Check những câu hỏi bài kiểm tra
        ...
        const autoRandom = () => {
            const maxSelected = 30; // Số lượng checkbox cần chọn
