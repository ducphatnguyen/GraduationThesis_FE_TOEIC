                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" :id="'editQuestionModalLabel-' + question.questionId"><i
                                                class="fas fa-edit" style="color: rgb(192, 129, 13)"></i> Edit Speaking Question (No 3 - 4)</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <QuestionEditNo3To4 :questionId="question.questionId" :sectionId="sectionId"
...
import QuestionEditNo3To4 from "@/views/questionbysection/QuestionEditNo3To4.vue";
