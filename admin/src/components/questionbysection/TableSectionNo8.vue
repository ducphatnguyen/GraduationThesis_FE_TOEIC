    ...
    <table class="table text-center table-hover shadow">
        ...
        <tbody>
            <tr v-for="(question, index) in paginatedQuestions" :key="question.questionId"
                ...
                <td v-html="question.suggestedAnswer"></td>
                <td>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" :id="'editQuestionModalLabel-' + question.questionId">
                                            <i class="fas fa-edit" style="color: rgb(192, 129, 13)"></i> Edit Writing
                                            Question (No 8)
                                        </h1>
                                    ...
                                    <QuestionEditNo8 :questionId="question.questionId" :sectionId="sectionId"
...
import QuestionEditNo8 from "@/views/questionbysection/QuestionEditNo8.vue";
