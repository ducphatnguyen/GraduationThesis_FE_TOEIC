            ...
            <template v-for="(groupedQuestions, groupId, groupIndex) in groupedQuestionMap" :key="groupId">
                ...
                class="table-row shadow-on-hover align-middle">
                    ...
                    <td v-if="index === 0" :rowspan="groupedQuestions.length">
                        ...
                        <!-- {{ question.questionGroup.groupText }} -->
                    </td>
                                        ...
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5"
                                                :id="'editQuestionModalLabel-' + question.questionGroup.groupId"><i class="fas fa-edit"
                                                    style="color: rgb(192, 129, 13)"></i> Edit Speaking Question (No 8 To 10)</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <QuestionEditNo8To10 :groupId="question.questionGroup.groupId" :sectionId="sectionId"
...
import QuestionEditNo8To10 from "@/views/questionbysection/QuestionEditNo8To10.vue";
