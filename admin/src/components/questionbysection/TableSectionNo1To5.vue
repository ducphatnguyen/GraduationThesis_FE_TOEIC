                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" :id="'editQuestionModalLabel-' + question.questionId"><i
                                                class="fas fa-edit" style="color: rgb(192, 129, 13)"></i> Edit Writing Question (No 1-5)</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <QuestionEditNo1To5 :questionId="question.questionId" :sectionId="sectionId"
...
import QuestionEditNo1To5 from "@/views/questionbysection/QuestionEditNo1To5.vue";
