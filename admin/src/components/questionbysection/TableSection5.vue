                        ...
                        <div :id="'editQuestionModal-' + question.questionId" class="modal zoom" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <QuestionEditSection5 :questionId="question.questionId" :sectionId="sectionId"
...
import QuestionEditSection5 from "@/views/questionbysection/QuestionEditSection5.vue";
