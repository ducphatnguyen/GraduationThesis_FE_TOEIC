<template>
    <table class="table text-center table-hover shadow">
        ...
        <tbody>
            <tr v-for="(question, index) in paginatedQuestions" :key="question.Id" class="table-row shadow-on-hover align-middle">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" :id="'editQuestionModalLabel-' + question.questionId"><i
                                                class="fas fa-edit" style="color: rgb(192, 129, 13)"></i> Edit Question Section 2</h1>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <QuestionEditSection2 :questionId="question.questionId" :sectionId="sectionId"
                                        :retrieveQuestions="retrieveQuestions"  />
                                </div>
                            </div>
                        </div>
                        <button type="button" @click="deleteQuestion(question.questionId)" class="btn btn-white ms-3 border-0">
...
import QuestionEditSection2 from "@/views/questionbysection/QuestionEditSection2.vue";
