                                        ...
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5"
                                                :id="'editQuestionModalLabel-' + question.questionGroup.groupId"><i class="fas fa-edit"
                                                    style="color: rgb(192, 129, 13)"></i> Edit Question Section 4</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <QuestionEditSection4 :groupId="question.questionGroup.groupId" :sectionId="sectionId"
...
import QuestionEditSection4 from "@/views/questionbysection/QuestionEditSection4.vue";
